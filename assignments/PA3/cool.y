...
%}
    ...
    */
	...
	%type <formal> formal
	%type <expressions> real_arg_list
...
%%
    ...
    */
	...
	OBJECTID ASSIGN expression
		{ $$=assign($1,$3); }
	| expression '.' OBJECTID '(' real_arg_list ')'
		{ $$=dispatch($1,$3,$5); }
	| expression '@' TYPEID '.' OBJECTID '(' real_arg_list ')'
		{ $$=static_dispatch($1,$3,$5,$7); }
	| OBJECTID '(' real_arg_list ')'
